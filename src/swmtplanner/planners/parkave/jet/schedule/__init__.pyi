...
class JetSched(Schedule, read_only=('jet','n_ports','jss','mss')):
    ...
    @property
    def mss(self) -> Shade: ...
    def get_prev_lots(self, lots: list[DyeLot]) -> list[DyeLot]: ...
    def expected_end(self, lots: list[DyeLot]) -> dt.datetime: ...
    def can_add_lots(self, new: list[DyeLot] | DyeCycleView, _: dt.timedelta) -> bool: ...
    def add_lots(self, new: list[DyeLot] | DyeCycleView, _: dt.timedelta,
                 idx: int | None = None) -> list[DyeCycle]: ...
    def add_job(self, job: DyeCycle, force: bool = False) -> None: ...
    def get_costs(self, nweeks: int) -> tuple[float, float, float]: ...
