...
class Schedule(SwmtBase, HasID[str]):
    ...
    def time_open(self, rng: DateRange) -> dt.timedelta: ...
    def nearest_time_open(self, date: dt.datetime) -> dt.datetime: ...
    def end_in_schedule(self, start: dt.datetime, cycle_time: dt.timedelta) -> dt.datetime: ...
    def can_add_cycle(self, min_date: dt.datetime, cycle_time: dt.timedelta) -> bool: ...
    def can_add_lots(self, new: list[Lot] | JobView, cycle_time: dt.timedelta) -> bool: ...
    def add_lots(self, new: list[Lot] | JobView, cycle_time: dt.timedelta,
                 idx: int | None = None) -> list[Job]: ...
