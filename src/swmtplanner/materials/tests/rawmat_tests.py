...
class GreigeRollInstantiationTests(unittest.TestCase):
    ...
    def test_construction_avail_date_none(self):
        """2.1.1: attribute pass-through with avail_date=None"""
    ...
    def test_construction_avail_date_future(self):
        """2.1.1: attribute pass-through with a future avail_date"""
        d = date(2026, 7, 1)
...
class SplitTests(unittest.TestCase):
    ...
    def test_split_weights_under_qty_raises(self):
        """2.2.1: lbs1 + lbs2 < self.qty raises ValueError"""
    ...
    def test_split_id_suffix_scheme(self):
        """2.2.2: new rolls' IDs are the parent's ID suffixed with 'A' and 'B'"""
    ...
    def test_split_half_into_two_partials(self):
        """2.2.3: half (50) -> 25 + 25 produces two 'partial' rolls"""
    ...
    def test_split_small_into_two_partials(self):
        """2.2.3: small (70) -> 35 + 35 produces two 'partial' rolls"""
...
class CombineTests(unittest.TestCase):
    ...
    def test_different_plants_raises(self):
        """2.3.1: combining rolls from different plants raises ValueError"""
    ...
    def test_different_items_raises(self):
        """2.3.1: combining rolls of different greige items raises ValueError"""
    ...
    def test_combined_id_always_concatenated(self):
        """2.3.2: id is always the concatenation of the two source ids"""
    ...
    def test_combined_variant_and_merge_match(self):
        """2.3.2: matching variant and matching merge keep single values"""
    ...
    def test_combined_variant_and_merge_differ(self):
        """2.3.2: differing variant and differing merge both get concatenated"""
        r1 = self._roll(20.0, 'FS001', variant='V1', merge='M1')
    ...
    def test_combine_partials_to_half(self):
        """2.3.3: partial (30) + partial (20) = half (50)"""
    ...
    def test_combine_partials_to_small(self):
        """2.3.3: partial (35) + partial (35) = small (70)"""
